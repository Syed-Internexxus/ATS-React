          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-animated thq-button-filled">
              <span className="thq-body-small">
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text21">Sign Up</span>
                  </Fragment>
                )}
              </span>
            </button>
                            ...
                            {props.page1Description ?? (
                              <Fragment>
                                <span className="navbar8-text13 thq-body-small">
                                  Check your resume compatibility with ATS
                                  systems.
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text16 thq-body-small">
                                  Explore the features of our ATS compatibility
                                  tool.
                                </span>
                              </Fragment>
                            )}
            ...
            <div className="navbar8-buttons2">
              ...
              <button className="thq-button-outline">
                <span>
                  {props.action2 ?? (
                    <Fragment>
                      <span className="navbar8-text24">Learn More</span>
                    </Fragment>
                  )}
                </span>
              </button>
...
Navbar8.defaultProps = {
  ...
  page4ImageSrc:
    'https://images.unsplash.com/photo-1677924656040-703debadc2f8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNTI5Mzc4OXw&ixlib=rb-4.0.3&q=80&w=1080',
  page1Description: undefined,
  page3Description: undefined,
  page2: undefined,
  page3ImageSrc:
    'https://images.unsplash.com/photo-1587317028130-ed1bd3c365c8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNTI5Mzc5MHw&ixlib=rb-4.0.3&q=80&w=1080',
  page2Description: undefined,
  page4Description: undefined,
  link4: undefined,
  page3ImageAlt: 'About Image',
  link2: undefined,
  page1ImageSrc:
    'https://images.unsplash.com/photo-1674816926776-fdd75d2e1890?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNTI5Mzc4OHw&ixlib=rb-4.0.3&q=80&w=1080',
  logoSrc:
  ...
  logoAlt: 'ATS Compatibility Checker',
  link3: undefined,
  ...
  page2ImageSrc:
    'https://images.unsplash.com/photo-1699541615607-056f070e4cdc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcyNTI5Mzc4OXw&ixlib=rb-4.0.3&q=80&w=1080',
}
